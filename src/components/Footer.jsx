...
import { Mail, Github, Linkedin, Send, MessageCircle, Phone, X, MessageSquare } from 'lucide-react';
...
const Footer = () => {
    ...
    return (
        <>
            <footer id="contact" className="py-24 border-t border-white/5 relative">
                <hr className="custom-line" />
                <div className="container text-center">
                    <h2 className="text-4xl font-bold mb-6 gradient-text">Let's build something together</h2>
                    ...
                    <div className="flex justify-center gap-6 mb-12">
                        <div className="relative">
                            <button
                                ...
                                className="p-4 flex items-center gap-2 rounded-full glass hover:bg-primary transition-all text-white font-medium shadow-[0_4px_15px_rgba(99,102,241,0.2)]"
                            >
                            ...
                            <AnimatePresence>
                                {contactOpen && (
                                    <motion.div
                                        ...
                                        style={{ bottom: '100%', marginBottom: '0.5rem', width: '200px' }}
                                        className="absolute left-1/2 -translate-x-1/2 p-2 glass rounded-2xl border border-white/10 shadow-2xl z-50 flex flex-col gap-2"
                                    >
                        ...
                        <a href="https://github.com/alshin5551" target="_blank" rel="noopener noreferrer" className="p-4 rounded-full glass hover:bg-primary transition-all hover:scale-110">
                            <Github size={24} />
                        </a>
                        <a href="https://www.linkedin.com/in/alshin-d-coutho/" target="_blank" rel="noopener noreferrer" className="p-4 rounded-full glass hover:bg-primary transition-all hover:scale-110">
                            <Linkedin size={24} />
                        </a>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-4 text-sm text-muted">
                        <div className="flex items-center gap-2">
                            ...
                            <span>Designed & Built by Alshin D coutho</span>
                            <span className="w-8 h-[1px] bg-white/10"></span>
                        </div>
